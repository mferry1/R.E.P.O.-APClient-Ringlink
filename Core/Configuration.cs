...
namespace RepoAP
{
    public class PluginConfig
    {
        ...
        public ConfigEntry<int> TruckScreenChatMessageFrequency;
        public PluginConfig(ConfigFile cfg)
        {
            ...
            TruckScreenChatMessageFrequency = cfg.Bind("General", "Truck screen message delay", 100, "Delay (in milliseconds) between Archipelago messages that appear on the truck screen. " +
                "1 second = 1000 milliseconds. 0 means that messages will appear in real-time.");
